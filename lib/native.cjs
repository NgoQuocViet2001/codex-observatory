...
function fallbackHelp() {
  return [
    "Prebuilt binaries are available for Windows x64, Windows arm64, macOS Intel, macOS Apple Silicon, Linux x64, and Linux arm64.",
    "If you are on one of those platforms, retry the command or download the matching asset from:",
